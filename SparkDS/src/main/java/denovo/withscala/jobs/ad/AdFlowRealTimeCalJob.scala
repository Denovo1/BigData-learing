package denovo.withscala.jobs.ad

import java.util
import java.util.Date

import denovo.withjava.bean.ad.{AdBlackList, AdClickTrend, AdProvinceTop3, AdStat, AdUserClickCount}
import denovo.withjava.dao.ad.{IADUserClickCountDao, IAdBlackListDao, IAdClickTrendDao, IAdProvinceTop3Dao, IAdStatDao}
import denovo.withjava.dao.ad.impl.{ADUserClickCountDaoImpl, AdBlackListDaoImpl, AdClickTrendDaoImpl, AdProvinceTop3DaoImpl, AdStatDaoImpl}
import denovo.withjava.utils.{DateUtils, ResourcesUtils, StringUtils}
...
import denovo.withjava.bean.ad._
import denovo.withjava.dao.ad.impl._
import denovo.withjava.dao.ad._
